        ...
        return (
            <div style={{ 'margin-bottom': '2%' }}>
                ...
                {this.state.ShowDetails ?
                    <Loader loading={this.props.userDetail.loading} error={this.props.userDetail.error}>
...
export default withRouter(connect(mapStateToProps, { getUserDetailsAction })(User))
