						...
						<div  className="search-form">
							<form >
								<div className="input-block-search">
									<input id="cat" name="cat" type="text"  title="What type of professional you need?" placeholder="What type of professional you need?"  className="ui-autocomplete-input inputDashboard" style={{ background :'#fff'}} />
								</div>
								<div  className="input-block-search-loc">
									<input type="text" title="Where?" placeholder="Where?" name="city" id="city"  className="loc pac-target-input inputDashboard" />
